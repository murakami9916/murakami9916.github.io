...
## 職務要約
物質・材料の計測データ解析において，情報科学技術を取り入れた新たな解析手法の研究開発を行ってきました．これらの研究開発は，物質・材料研究機構(NIMS)や高輝度光科学研究センター(Spring-8)などの研究機関と共同で行い，開発した手法を実解析現場のユーザに利用していただく部分まで活動を行なっております．これまでの成果として，私は[論文8編(筆頭4編，共著4編)](#研究活動に関する業績)を発表した．また，[約40件の学会発表](https://murakami9916.github.io/presentation_list)を行った．
